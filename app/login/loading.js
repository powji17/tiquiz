    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-2xl" style={{ border: "1px solid var(--color-line)" }}>
          <div className="h-7 w-44 rounded mb-2 animate-pulse" style={{ background: "var(--color-line)" }} />
          <div className="h-4 w-60 rounded mb-6 animate-pulse" style={{ background: "var(--color-line)" }} />
