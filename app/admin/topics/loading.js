  ...
  return (
    <main className="px-6 py-8 max-w-3xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="h-9 w-32 rounded-xl animate-pulse" style={{ background: "var(--color-line)" }} />
      </div>
        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            <div className="flex-1">
              ...
              <div className="h-3 w-56 rounded animate-pulse" style={{ background: "var(--color-line)" }} />
            </div>
